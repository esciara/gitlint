...
class LintConfigTests(BaseTestCase):
    ...
    def test_contrib_negative(self):
        ...
        side_effects = [user_rules.UserRuleError(u"üser-rule"), options.RuleOptionError(u"rüle-option")]
        for side_effect in side_effects:
            with patch('gitlint.config.user_rules.find_rule_classes', side_effect=side_effect):
